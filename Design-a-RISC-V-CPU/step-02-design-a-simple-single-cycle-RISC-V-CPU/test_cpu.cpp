#include <memory>
#include <verilated.h>
#include "VRISCV_CPU.h"  // Replace with your generated top module header
...
int main(int argc, char** argv) {
    ...
    const std::unique_ptr<VRISCV_CPU> top{new VRISCV_CPU{contextp.get(), "RISCV_CPU"}};
    ...
    // Example: Assuming `instr_mem` is an array for instruction memory
    // Initialize it by modifying your top module or preloading a memory file
    // (e.g., use $readmemh in Verilog)
